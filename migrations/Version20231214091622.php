 ...
 */
final class Version20231214091622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE centre_relais_user (centre_relais_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9C56AF43AC2504A9 (centre_relais_id), INDEX IDX_9C56AF43A76ED395 (user_id), PRIMARY KEY(centre_relais_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
